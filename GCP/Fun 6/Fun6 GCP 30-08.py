...
archivo='gs://nhl-test-2/StatsPlayers_2024-2025.csv'
archivo_base=pd.read_csv(archivo, sep=',')

#archivo_base=pd.read_csv('Data_csv/Test_Players_2023-2024.csv', sep=',')  ##SOLO PARA TESTEAR

url='https://api-web.nhle.com/v1/schedule/now'  #DESBLOQUEAR PARA LA SEASON GCP

#url='https://api-web.nhle.com/v1/schedule/2024-02-24' # SOLO PARA TESTEAR
...
if len(games_list)==0:
    ...
    for l in id_matches_Links:
        ...
        quedan=quedan-1
        url=f'https://www.nhl.com/scores/htmlreports/20242025/PL0{l}.HTM'  ####MODIFICAR 20242025 EN GCP
        ...
        skaters=skaters_(f'https://api-web.nhle.com/v1/gamecenter/20240{l}/boxscore') ###Cambiar a 2024 si la season es 2024-2025
    ...
    id_skaters=pd.read_csv(id_players, sep=',')
    ...
    #corsi_skaters.to_csv('Data_csv/Test_Players_2023-2024.csv', index=False)  ###SOLO PARA TEST
