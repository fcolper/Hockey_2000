...
def _update():
    ...
    #combined_df.to_csv(f'Data_csv/TeamsMatches_2024-2025.csv', index=False) #PRIMER ARCHIVO
    ...
    #new_teams_season.to_csv(f'Data_csv/TeamsMatches_2024-2025.csv', index=False) #DESBLOQUEAR PARA LA SEASON
