...
#archivo_base=pd.read_csv('Data_csv/Test_Players_2023-2024.csv', sep=',')
...
if len(games_list)==0:
    ...
    id_players='Data_csv/Players_20002024.csv'  ###SOLO PARA TEST
    ...
    corsi_skaters.to_csv('Data_csv/StatsPlayers_2024-2025_test.csv', index=False)
