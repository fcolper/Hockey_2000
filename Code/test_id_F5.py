...
year=2009
c=f'Data_csv/TeamsMatches_{year}-{year+1}.csv'
...
# url='https://api-web.nhle.com/v1/schedule/2024-02-24' #Test
...
for l in id_matches_Links:
    print(l)
    url=f'https://www.nhl.com/scores/htmlreports/{year}{year+1}/PL0{l}.HTM' #MODIFICAR 2024-2025
    ...
    if 'Sit.Str' in str_frances:
        ...
        df_home_EV_Shot=df_home_EV[df_home_EV['JeuEvent']=='SHOT']
        #print('df_home_EV_Shot:', df_home_EV_Shot)
        df_home_EV_Goal=df_home_EV[df_home_EV['JeuEvent']=='GOAL']
        ...
        df_home_EV=df_home[df_home[str_frances]=='EV']
        df_home_EV_Miss=df_home_EV[df_home_EV['JeuEvent']=='MISS']
        #print(df_home_EV_Miss)
        corsifor_miss_EV=len(df_home_EV_Miss)
        #print(len(df_home_EV_Miss))
        df_home_EV=df_home[df_home[str_frances]=='EV']
        df_home_EV_Block=df_home_EV[df_home_EV['JeuEvent']=='BLOCK']
        ...
        df_away_EV=df_away[df_away[str_frances]=='EV']
        df_away_EV_Shot=df_away_EV[df_away_EV['JeuEvent']=='SHOT']
        df_away_EV_Goal=df_away_EV[df_away_EV['JeuEvent']=='GOAL']
        ...
        df_away_EV=df_away[df_away[str_frances]=='EV']
        df_away_EV_Miss=df_away_EV[df_away_EV['JeuEvent']=='MISS']
        ...
        df_away_EV=df_away[df_away[str_frances]=='EV']
        df_away_EV_Block=df_away_EV[df_away_EV['JeuEvent']=='BLOCK']
        ...
        #print(df_5v5_ANA)
        df_5v5_ANA_shots=df_5v5_ANA[df_5v5_ANA['JeuEvent']=='SHOT']
        df_5v5_ANA_goal=df_5v5_ANA[df_5v5_ANA['JeuEvent']=='GOAL']
        #print(df_5v5_ANA_shots)
        #print(len(df_5v5_ANA_shots))
        df_5v5_ANA_miss=df_5v5_ANA[df_5v5_ANA['JeuEvent']=='MISS']
        #print(df_5v5_ANA_miss)
        #print(len(df_5v5_ANA_miss))
        df_5v5_ANA_block=df_5v5_ANA[df_5v5_ANA['JeuEvent']=='BLOCK']
        ...
        #print(df_5v5_TOR)
        df_5v5_TOR_shots=df_5v5_TOR[df_5v5_TOR['JeuEvent']=='SHOT']
        df_5v5_TOR_goal=df_5v5_TOR[df_5v5_TOR['JeuEvent']=='GOAL']
        #print(df_5v5_TOR_shots)
        #print(len(df_5v5_TOR_shots))
        df_5v5_TOR_miss=df_5v5_TOR[df_5v5_TOR['JeuEvent']=='MISS']
        #print(df_5v5_TOR_miss)
        #print(len(df_5v5_TOR_miss))
        df_5v5_TOR_block=df_5v5_TOR[df_5v5_TOR['JeuEvent']=='BLOCK']
    ...
    new_url=f'https://api-web.nhle.com/v1/gamecenter/{year}0{l}/landing' #Cambiar a 2024 si la season es 2024-2025
...
#combined_df.to_csv(c, index=False) #PRIMER ARCHIVO
...
new_teams_season.sort_values('gameId', inplace=True)
new_teams_season.to_csv(c, index=False) #DESBLOQUEAR PARA LA SEASON